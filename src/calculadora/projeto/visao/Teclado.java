package calculadora.projeto.visao;
...
import calculadora.projeto.modelo.Memoria;
...
public class Teclado extends JPanel implements ActionListener{
	...
	private final Color COR_CINZA_ESCURO = new Color(68, 68, 68);
       ...
       public Teclado() {
    	   ...
    	   GridBagLayout layount = new GridBagLayout();
	...
	public void actionPerformed(ActionEvent e) {
		...
		Memoria.getInstancia().provessarComando(botao.getText());
		}
	}
